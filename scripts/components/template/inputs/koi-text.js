...
text_template.innerHTML = `
  ...
  <div id="koinputTxtWrap" class="koinputTxtWrap">
		<textarea class="koinputTxt" id="koinputTxt" name="koinputTxtForm" rows="1" wrap="soft"  placeholder="" onkeyup="this.getRootNode().host.updateView(this.value)"></textarea>
