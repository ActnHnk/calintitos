...
class KoiForm extends KoiComponent {
...
const register_form = () => customElements.define(form, KoiForm);
window.WebComponents ? window.WebComponents.waitFor(register_form) : register_form();
