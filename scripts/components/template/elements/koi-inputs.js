...
class KoiInput extends KoiComponent {
  ...
  constructor() {
    super();
    var classname = FirebaseRtdb;
    //ASSIGN YOUR CONNECTION HERE FOR NOW
    //SHOULD REALLY MAKE PILOTCOMPONENTS INSTEAD
    this.assignConnection(this, className);
  }
  //<koi-input type="text" connection="Mysql" placeholder="demo input"/>
  //<input type="text" placeholder="demo"/> [_______]
  //
